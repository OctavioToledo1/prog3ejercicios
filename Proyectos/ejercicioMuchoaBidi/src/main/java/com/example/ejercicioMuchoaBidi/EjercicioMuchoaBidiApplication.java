package com.example.ejercicioMuchoaBidi;

import com.example.ejercicioMuchoaBidi.entidades.Domicilio;
import com.example.ejercicioMuchoaBidi.entidades.Persona;
import com.example.ejercicioMuchoaBidi.repositorios.DomicilioRepository;
import com.example.ejercicioMuchoaBidi.repositorios.PersonaRepository;
...
public class EjercicioMuchoaBidiApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(EjercicioMuchoaBidiApplication.class, args);
		System.out.println("BIDIRECCIONAL ONETOMANY");
	}
