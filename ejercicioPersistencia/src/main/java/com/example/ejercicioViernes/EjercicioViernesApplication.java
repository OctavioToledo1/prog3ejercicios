package com.example.ejercicioViernes;

import com.example.ejercicioViernes.entidades.*;
import com.example.ejercicioViernes.repositorios.*;
...
public class EjercicioViernesApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(EjercicioViernesApplication.class, args);
